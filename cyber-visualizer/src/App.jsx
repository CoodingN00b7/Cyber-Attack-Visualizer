...
export default function App() {
  ...
  const navLink = active =>
    dark
      ? active ? "text-cyan-300 bg-cyan-400/10 border border-cyan-300/20 shadow-[0_0_12px_-4px_rgba(34,211,238,.32)]"
               : "text-slate-400 hover:text-white hover:bg-white/5 border border-transparent"
      : active ? "text-cyan-800 bg-cyan-100/80 border border-cyan-200 shadow-sm"
               : "text-slate-500 hover:text-slate-900 hover:bg-black/5 border border-transparent";

  const govLink = active =>
    dark
      ? active ? "text-cyan-300 bg-cyan-400/10 border border-cyan-400/25"
               : "text-slate-400 hover:text-cyan-300 hover:bg-cyan-400/5 border border-transparent"
      : active ? "text-cyan-800 bg-cyan-100/80 border border-cyan-200"
               : "text-slate-500 hover:text-cyan-800 hover:bg-cyan-50 border border-transparent";
    ...
    <div className="min-h-screen flex flex-col transition-colors duration-300"
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        <div style={{ position:"absolute", top:"-20%", left:"-10%", width:"55%", height:"55%",
          background: dark?"radial-gradient(ellipse,rgba(34,211,238,.08) 0%,transparent 70%)":"radial-gradient(ellipse,rgba(34,211,238,.1) 0%,transparent 70%)", filter:"blur(60px)" }}/>
        <div style={{ position:"absolute", bottom:"-20%", right:"-10%", width:"55%", height:"55%",
          background: dark?"radial-gradient(ellipse,rgba(14,165,233,.07) 0%,transparent 70%)":"radial-gradient(ellipse,rgba(8,145,178,.08) 0%,transparent 70%)", filter:"blur(60px)" }}/>
