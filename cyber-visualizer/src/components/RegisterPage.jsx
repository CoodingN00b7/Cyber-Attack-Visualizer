  ...
  return (
    <div className="min-h-screen relative overflow-hidden" style={{ backgroundColor: "var(--bg-base)", color: "var(--text-primary)" }}>
      ...
      <div className="relative z-10 mx-auto grid min-h-screen max-w-[1440px] grid-cols-1 lg:grid-cols-[0.92fr_1.08fr]">
        <section className="flex items-center px-5 py-10 sm:px-10 lg:px-14 lg:py-16">
          <motion.div
          ...
          >
            ...
            <h1 className="bg-gradient-to-r from-cyan-400 via-sky-500 to-blue-500 bg-clip-text text-4xl font-black tracking-[0.12em] text-transparent sm:text-6xl">
              CYBER ATTACK VISUALIZER
            </h1>
            <p className="mt-4 max-w-lg text-base sm:text-lg leading-7" style={{ color: "var(--text-secondary)" }}>
              ...
              {[
                ...
                return (
                  ...
                  >
                    ...
                    <p className="mt-3 text-sm font-bold" style={{ color: "var(--text-primary)" }}>{item.title}</p>
                    <p className="mt-1 text-xs leading-5" style={{ color: "var(--text-secondary)" }}>{item.note}</p>
                  </div>
                );
              })}
            </div>
        ...
        <section className="flex items-center justify-center px-5 pb-12 pt-4 sm:px-10 lg:px-14 lg:py-16">
          <motion.div
          ...
          >
            <div className="glass-2 relative overflow-hidden rounded-[28px] shadow-2xl">
              <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-cyan-400 via-sky-500 to-blue-500" />
              <div className="p-5 sm:p-8">
                <div className="mb-7 flex items-center gap-4">
                  <div className="flex h-14 w-14 items-center justify-center rounded-2xl border" style={{ borderColor: "var(--border)", background: "var(--bg-inset)" }}>
                    <Shield className="h-7 w-7 text-sky-500" />
                  </div>
                  <div>
                    <p className="text-xs font-bold uppercase tracking-[0.24em]" style={{ color: "var(--text-secondary)" }}>Join the platform</p>
                    <h2 className="mt-1 text-2xl font-black" style={{ color: "var(--text-primary)" }}>Create account</h2>
                  </div>
                </div>
                ...
                <AnimatePresence>
                  {success && (
                    ...
                    >
                      ...
                      <p className="text-lg font-bold" style={{ color: "var(--text-primary)" }}>Account created</p>
