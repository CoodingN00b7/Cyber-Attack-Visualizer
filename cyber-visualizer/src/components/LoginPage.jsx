            ...
            <div className="glass-2 relative overflow-hidden rounded-[28px] shadow-2xl">
              ...
              <div className="p-5 sm:p-8">
                <div className="mb-7 flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-xs font-bold uppercase tracking-[0.24em]" style={{ color: "var(--text-secondary)" }}>Welcome back</p>
                    <h2 className="mt-1 text-2xl font-black" style={{ color: "var(--text-primary)" }}>Sign in</h2>
                  </div>
                </div>

                <div className="mb-6 grid grid-cols-2 gap-2 rounded-2xl p-1" style={{ border: "1px solid var(--border)", background: "var(--bg-inset)" }}>
                  {[
